...
const getAll = async (req, res) => {
    try {
        ...
        const courses = await Course.findAndCountAll({
            attributes: ['id', 'title_course', 'description_course', 'color_course', 'status', 'createdAt', 'updatedAt'],
            order: [["id", "DESC"]],
            include: [
                { model: User, attributes: ['id', 'fullname'] },
                {
                    model: Index, attributes: ['id', 'title_index', 'description_index'],
                    include: { model: Index_Content, attributes: ['id', 'title_content', 'description_content', 'type', 'link_video'] }
                }
            ],
            offset: offset,
    ...
    try {
        ...
        if (exits) {
            await Index_Content.create({
                id_index: id, title_content: title_content,
